...
public class FXMLDocumentController implements Initializable {
    ...
    public void loginBtn() {
        if (si_username.getText().isEmpty() || si_password.getText().isEmpty()) {
            ...
            alert.setContentText("Fill the required details");
            alert.showAndWait();
        } else if (!isValidEmail(si_username.getText())) {
            // If username is not in a valid email format
            alert = new Alert(AlertType.ERROR);
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("Invalid email format. Please use abc@xyz.com format.");
            alert.showAndWait();
        } else {
    ...
    public void regBtn() {
        if (su_username.getText().isEmpty() || su_password.getText().isEmpty()
            ...
            alert.showAndWait();
        } else if (!isValidEmail(su_username.getText())) {
            // If username is not in a valid email format
            alert = new Alert(AlertType.ERROR);
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
